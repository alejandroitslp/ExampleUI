            ...
            Column(
                ...
                Row(modifier=Modifier.fillMaxWidth()){
                    ...
                    Column(horizontalAlignment = Alignment.End, modifier= Modifier
                        ...
                        Text(text = "View all", color= dark_blue)
                    }
                }
                LazyRow(modifier=Modifier.padding(top = 15.dp)) {
                    items(randomCol?.randomCol?.size ?: 0){
                        ...
                        CardItems(image= randomCol?.randomCol?.get(item)?.image, desc= randomCol?.randomCol?.get(item)?.desc)
                        }
                        else{
                            CardItems(image= "R.drawable.abrazaditos", desc= randomCol?.randomCol?.get(item)?.desc)
                        }
                    }
                }
            }
